...
# Project:  QmlGame.pro
# Template: app
# Command: C:\Qt\5.4\mingw491_32\bin\qmake.exe -spec win32-g++ CONFIG+=debug CONFIG+=declarative_debug CONFIG+=qml_debug -o Makefile QmlGame.pro
#############################################################################
...
Makefile: QmlGame.pro ../../../Qt/5.4/mingw491_32/mkspecs/win32-g++/qmake.conf ../../../Qt/5.4/mingw491_32/mkspecs/features/spec_pre.prf \
	...
	$(QMAKE) -spec win32-g++ CONFIG+=debug CONFIG+=declarative_debug CONFIG+=qml_debug -o Makefile QmlGame.pro
